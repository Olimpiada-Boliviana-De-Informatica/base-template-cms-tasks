...
class DOMjudgeExporter:
    ...
    VERDICT_MAP = {
        verdicts.VERDICT__MODEL_SOLUTION: "accepted",
        verdicts.VERDICT__CORRECT: "accepted",
        verdicts.VERDICT__INCORRECT: "wrong_answer",
        verdicts.VERDICT__TIME_LIMIT_EXCEEDED: "timelimit",
        verdicts.VERDICT__MEMORY_LIMIT_EXCEEDED: "run_time_error",
        verdicts.VERDICT__RUNTIME_ERROR: "run_time_error"
    }
...
""".format(
    ...
    def export_solutions(self):
        ...
        for solution_name, solution_data in solutions_data.items():
            ...
            verdict_dir = self.VERDICT_MAP.get(verdicts.get_unified(verdict)) if verdict else None
            if not verdict_dir:
...
def main():
    ...
    file_name = args.output_name if args.output_name else prob.short_name()
